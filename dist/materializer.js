...
export async function computeRuntimeHash(runtimeRoot) {
    return hashTree(runtimeRoot);
}
export async function computeRuntimeFileHashes(runtimeRoot) {
    return hashFiles(runtimeRoot);
}
async function assertRuntimeClean(workspace, force) {
...
async function hashManagedRuntime(runtimeRoot) {
...
export async function computeCurrentRuntimeHash(workspace) {
...
async function assertOverlaySafe(overlayRoot) {
...
export async function readRuntimeHashFromState(workspace) {
