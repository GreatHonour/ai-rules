...
- **UI 或组件**
  - 设计内容：Props、Events、Slots、交互状态、视觉约束、可访问性

- **API 或服务**
  - 设计内容：请求响应、错误语义、权限、限流、幂等

- **数据变更**
  - 设计内容：Schema、迁移、兼容、回滚

- **异步流程**
  - 设计内容：状态机、超时、重试、补偿、可观测性

- **ToC 活动或交易**
  - 设计内容：资格、时间、次数/金额、概率、库存、发放、撤销、风控

- **外部平台**
  - 设计内容：能力探测、授权、失败降级、责任边界
