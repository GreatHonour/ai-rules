...
2. **读取预期**：读取 `design.md`、`AGENTS.md`、`code-quality.md` 和本次改动适用的项目规则。
...
`review.md` 是过程清单，由 `flow-archive/SKILL.md` 直接删除。
...
## Flow v2 外部资源
外部模板：`../templates/review.md`；共享规则：`../shared/evidence-contract.md`。
